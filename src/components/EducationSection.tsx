...
export const EducationSection: React.FC = () => {
  ...
  const radarItems = [
    ...
    },
    {
      ...
      icon: <Code2 className="w-3.5 h-3.5 text-zinc-300" />
    },
    {
      label: 'Playing',
      value: currently.playing,
      icon: <Gamepad2 className="w-3.5 h-3.5 text-zinc-300" />
    },
    {
      label: 'Thinking About',
      value: currently.thinking,
      icon: <Lightbulb className="w-3.5 h-3.5 text-zinc-300" />
    }
  ];

  return (
    <section id="education" className="py-28 px-6 sm:px-8 border-b border-white/10 bg-[#09090b] relative">
      <div className="max-w-6xl mx-auto space-y-12">
        {/* Section Header */}
        <div className="flex items-center gap-3">
          <span className="font-mono text-xs text-white font-bold">06 //</span>
        ...
        <div className="max-w-2xl">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-editorial text-white">
            Engineering the next step<span className="text-zinc-600">.</span>
          </h2>
        </div>

        {/* Compact Education Card */}
        <div className="rounded-2xl border border-white/10 bg-zinc-900/40 p-6 sm:p-8 flex flex-col md:flex-row md:items-center justify-between gap-6 shadow-sm">
          <div className="space-y-2">
            ...
            <p className="text-sm sm:text-base text-zinc-300">
              {education.degree} — <span className="text-white font-semibold">{education.specialization}</span>
            </p>
          ...
          {/* CGPA Callout Badge */}
          <div className="flex-shrink-0 p-5 rounded-xl border border-white/15 bg-zinc-950 text-center min-w-[170px]">
        ...
        <div className="rounded-2xl border border-white/10 bg-zinc-900/30 p-6 sm:p-8 shadow-sm">
          <div className="flex items-center justify-between gap-4 mb-6 pb-4 border-b border-white/10">
            <div className="flex items-center gap-2.5">
              ...
              <span className="text-xs font-mono tracking-loose-caps uppercase text-white font-bold">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {radarItems.map((item, idx) => (
              <div
                key={idx}
                className="p-4 rounded-xl border border-white/10 bg-zinc-950/70 flex flex-col justify-between min-h-[120px]"
              >
