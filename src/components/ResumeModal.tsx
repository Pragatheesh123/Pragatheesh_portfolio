        ...
        <div className="flex items-center justify-between px-6 py-4 bg-zinc-900/90 border-b border-white/10">
          ...
          <div className="flex items-center gap-2">
            ...
            <a
              ...
              className="inline-flex items-center gap-1.5 px-3.5 py-1.5 text-xs font-semibold text-black bg-white hover:bg-zinc-200 rounded-md transition-colors shadow-sm"
            >
            ...
            <button
              onClick={onClose}
              className="p-1.5 text-zinc-400 hover:text-white bg-white/[0.04] hover:bg-white/[0.1] rounded-md transition-colors ml-1"
